...
/// <reference types="node" />
export { capability, context, curveKeyPair, version, Context, Event, EventOfType, EventType, Socket, Observer, Proxy, } from "./native";
import { Context, EventOfType, EventType, Options, Socket } from "./native";
/**
 ...
 * {@link Writable.send}().
 */
export type MessageLike = ArrayBufferView | ArrayBuffer | SharedArrayBuffer | string | number | null;
/**
 ...
 * (DRAFT only).
 */
export interface Writable<M extends MessageLike | MessageLike[] = MessageLike | MessageLike[], O extends [...object[]] = []> {
    /**
     * ZMQ_MULTICAST_HOPS
     *
...
type ReceiveType<T> = T extends {
    receive(): Promise<infer U>;
} ? U : never;
/**
 ...
 */
export type SocketOptions<S extends Socket> = Options<S, {
    context: Context;
}>;
export interface EventSubscriber {
     ...
     */
    on<E extends EventType>(type: E, listener: (data: EventOfType<E>) => void): EventSubscriber;
    /**
     ...
     */
    off<E extends EventType>(type: E, listener: (data: EventOfType<E>) => void): EventSubscriber;
}
 ...
 */
export declare class Publisher extends Socket {
    /**
     * ZMQ_XPUB_NODROP
     *
 ...
 */
export declare class Subscriber extends Socket {
    /**
     * ZMQ_CONFLATE
     *
     * If set to `true`, a socket shall keep only one message in its
 ...
 * discard messages.
 */
export declare class Request extends Socket {
    /**
     * ZMQ_ROUTING_ID
     *
 ...
 */
export declare class Reply extends Socket {
    /**
     * ZMQ_ROUTING_ID
     *
     * The identity of the specified socket when connecting to a `Router` socket.
 ...
 */
export declare class XPublisher extends Socket {
    /**
     * ZMQ_XPUB_NODROP
     *
     * Sets the socket behaviour to return an error if the high water mark is
 ...
 * subscription status.
 */
export declare class XSubscriber extends Socket {
...
export interface Stream extends Readable<[Message, Message]>, Writable<[MessageLike, MessageLike]> {
}
