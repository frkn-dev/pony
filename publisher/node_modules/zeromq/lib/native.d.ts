 ...
 */
export type EventOfType<E extends EventType = EventType> = Expand<Extract<Event, Event & EventFor<E>>>;
/**
 ...
 */
export declare class Proxy<F extends Socket = Socket, B extends Socket = Socket> {
    /**
